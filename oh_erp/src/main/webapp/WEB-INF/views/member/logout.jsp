...
html {
	...
	body {
	    ...
	    margin: 0;
  		...
  		background:linear-gradient(to bottom right, #566270, #FFFFF3);
	}
...
<% session.invalidate(); %> 
 ...
 <img src="${pageContext.request.contextPath}/res/image/logo.png" class="mx-auto d-block" style="width:300px%">
   <br>
